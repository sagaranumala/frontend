    ...
    <>
      {  edit ?
        ...
        <table className='table-scenario'>
            <tr>
               <th className='scenario-row'>Scenario Id</th>
               <th className='scenario-row'>Scenario Name</th>
               <th className='scenario-row'>Scenario Time</th>
               <th className='scenario-row'>Number of Vehicals</th>
               <th className='scenario-row'>Add Vehicle</th>
               <th className='scenario-row'>Edit</th>
               <th className='scenario-row'>Delete</th>
            </tr>
            <tbody>
                {
